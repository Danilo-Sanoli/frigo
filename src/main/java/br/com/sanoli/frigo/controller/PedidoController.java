...
public class PedidoController {
	...
	@PutMapping("alterar-status/{idPedido}/{idStatus}")
	@ResponseBody
	public void alteraStatusPedido(@PathVariable("idPedido") Long idPedido, @PathVariable("idStatus") Long idStatus){
		service.alteraStatusPedido(idPedido, idStatus);
	}
